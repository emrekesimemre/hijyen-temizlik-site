      ...
      <header className="fixed w-full top-0 z-50 bg-white border-b border-slate-100 shadow-sm transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-24">
            ...
            <div className="flex items-center h-full py-3 shrink-0 z-50 relative">
              <img
                src="/logo.jpeg"
                alt="Hijyen Halı Temizleme Logosu"
                className="object-contain h-[60px] sm:h-[75px] w-auto mix-blend-multiply"
              />
            </div>
            ...
            <nav className="hidden xl:flex items-center gap-10">
              {NAV_LINKS.map((link, index) => (
                <a
                  key={index}
                  href={link.href}
                  className="text-[13px] font-bold tracking-widest uppercase text-slate-500 hover:text-blue-600 transition-colors outline-none focus:outline-none"
                >
                  {link.name}
                </a>
              ))}
            ...
            <div className="hidden lg:flex items-center gap-6 shrink-0">
              <div className="flex items-center gap-2 text-slate-800 font-bold text-lg">
                ...
                <a
                  ...
                  className="hover:text-blue-600 transition-colors outline-none focus:outline-none"
                >
                  {CONTACT_INFO.phone}
                </a>
              </div>

              {/* Daha ince, zarif ve kısa metinli CTA butonu */}
              <button
                onClick={() => {
                  setModalType("randevu");
                  setIsModalOpen(true);
                }}
                className="bg-emerald-500 hover:bg-emerald-600 text-white px-7 py-2.5 rounded-full text-sm font-bold tracking-wide flex items-center gap-2 transition-all shadow-lg shadow-emerald-500/20 outline-none focus:outline-none"
              >
            ...
            >
              <div className="bg-slate-50 px-6 py-4 border-b border-slate-100 flex justify-between items-center">
                <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2">
                  {modalType === "randevu" ? (
                    ...
                    <>
                      <Sparkles className="w-5 h-5 text-blue-500" /> Fiyat
                      Bilgisi Al
                    </>
                  )}
                </h3>
              ...
              <form onSubmit={handleWhatsAppSubmit} className="p-6 space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  {modalType === "fiyat" && (
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Örn: 12 m² veya 2 Adet"
                  ...
                  <div className={modalType === "fiyat" ? "sm:col-span-1" : ""}>
                    <label className="block text-sm font-medium text-slate-700 mb-1">
                      Hizmet Türü
                    </label>
                    <select
                ...
                <button
                  type="submit"
                  className={`w-full mt-2 text-white py-3.5 rounded-xl font-bold flex items-center justify-center gap-2 transition-colors shadow-lg ${
                    modalType === "randevu"
